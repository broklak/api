...
module.exports = (model, publicKEY, jwtVerifyOptions) => {
    ...
    // GET http://localhost:9000/degrees
    ...
    // GET http://localhost:9000/degrees/1
    ...
    // POST http://localhost:9000/degrees
    ...
    // PUT http://localhost:9000/degrees/:id
    ...
    // DELETE http://localhost:9000/degrees/:id
