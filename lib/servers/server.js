...
let Server = function (handlers) {
    ...
    this.app.use("/auth", handlers.auth);

    this.app.use("/users", handlers.user);
    this.app.use("/colleges", handlers.college);
    this.app.use("/directory", handlers.directory);
    this.app.use("/majors", handlers.major);
